...
const implementedRoutes = [
  ...
  { path: '/sales/customer', component: CustomerView, meta: { title: 'Customer Data', moduleId: 'sales', moduleName: 'Sales', layout: 'default' } },
  { path: '/settings/master-type', component: () => import('./views/settings/master_type/MasterTypeLayout.vue'), meta: { title: 'Master Type', moduleId: 'settings', moduleName: 'Settings', layout: 'default' } },
